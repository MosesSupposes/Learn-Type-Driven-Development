...
var ids$2 = CamlinternalOO.get_method_labels($$class$2, shared);

var name$2 = ids$2[0];

var id$2 = ids$2[1];

console.log(greet((CamlinternalOO.set_methods($$class$2, [
                id$2,
                (function (self$3) {
                    return 3;
                  }),
              ...
              ]), CamlinternalOO.init_class($$class$2), CamlinternalOO.create_object_opt(undefined, $$class$2))));
